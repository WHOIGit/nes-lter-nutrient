...
nutrients_compare_right <- right_join(nutrients_long, nutrients_pubd_long, by = c("event_number", "latitude", "longitude", "depth", "replicate"))
# use this right join in order to work with only the rows that are included in the old data set

#nutrients_compare_left <- left_join(nutrients_long, nutrients_pubd_long, by = c("event_number", "latitude", "longitude", "depth", "replicate"))
#nutrients_compare_full <- full_join(nutrients_long, nutrients_pubd_long, by = c("event_number", "latitude", "longitude", "depth", "replicate"))
#nutrients_compare_inner <- inner_join(nutrients_long, nutrients_pubd_long, by = c("event_number", "latitude", "longitude", "depth", "replicate"))

# compare nutrient values
nutrients_compare <- nutrients_compare_right  %>% 
...
# count_old <- nutrients_pubd_long %>%
#   filter(!is.na(nitrate_old))
# count_NaN <- nutrients_pubd_long %>%
