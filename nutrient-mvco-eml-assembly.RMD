...
pkg_id <- 'knb-lter-nes.1.3'  # previous version is knb-lter-nes.1.2 #this one knb-lter-nes.1.3?
make_eml(here(),
         dataset.title='Dissolved inorganic nutrients from NES-LTER cruises to the Marthas Vineyard Coastal Observatory (MVCO), including 4 macro-nutrients from water column bottle samples, ongoing since 2006', # should this include a reference to MVCO?
